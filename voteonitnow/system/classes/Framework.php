...
class Framework
{
    ...
    public function view($viewName, $data = [])
    {
        ...
        if (file_exists(BASE_DIR."/application/views/" . $viewName . ".php")) {

            require_once BASE_DIR."/application/views/" . $viewName . ".php";
        } else {
    ...
    public function model($modelName)
    {
        ...
        if (file_exists(BASE_DIR."/application/models/" . $modelName . ".php")) {

            require_once BASE_DIR."/application/models/" . $modelName . ".php";
    ...
    public function helper($helperName,$data=[])
    {
        ...
        if (file_exists(BASE_DIR."/system/helpers/" . $helperName . ".php")) {

            require_once BASE_DIR."/system/helpers/" . $helperName . ".php";
        } else {
    ...
    public function includeFile($fileName){
        ...
        if (file_exists(BASE_DIR."/application/views/" . $fileName . ".php")) {

            require_once BASE_DIR."/application/views/" . $fileName . ".php";
        } else {
